...
**Scope and limitations:** This guide covers Anomaly 1.5.2. Some details may differ for older versions or derived modpacks (GAMMA, EFP, etc.). Engine-internal C++ behaviour is documented by observed effect, not by reading source — if something contradicts what you see in-game, the game wins.
